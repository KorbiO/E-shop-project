...
public class FournisseurController {
		...
		public VenteFlash postVenteFlash (@RequestBody VenteFlash venteFlash )
		{
			...
			List<ArticleVenteFlash> l1 = new ArrayList<>();
			List<ArticleVenteFlash> l2 = new ArrayList<>();
			l1.addAll(v.getArticleVenteFlash());
			l2.addAll(venteFlash.getArticleVenteFlash());
			l2.addAll(l2.size(), l1);
			v1.setArticleVenteFlash(l2);
			for (ArticleVenteFlash name : l2) {
				fournisseurService.addArticleVenteFlash(name);
			}
